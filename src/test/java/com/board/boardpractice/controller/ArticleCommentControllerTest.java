...
import com.board.boardpractice.config.TestSecurityConfig;
...
class ArticleCommentControllerTest {
    ...
    @WithUserDetails(value = "userIdForTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)
